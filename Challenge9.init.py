...
locations = shelve.open('locations')  # shelve keys have to be strings, compared to dictionaries
...
locations.close()  # its a good practice to close shelves right after using them
